        ...
        <div className={"container"}>
          <div className={`body__container ${isAccImported ? " body__container_has_imported" : ""}`}>
            <div className={"body__content"}>
              ...
              <div className="body__title-sub">As CONST is upgrading its TRC20 contract, we temporary disable TomoSwap service between TOMO and CONST and re-enable when the migration is done. <p /> Please read [<a rel="noopener noreferrer" href="https://medium.com/@constantp2p/to-all-trc20-constant-holders-were-moving-e3a5ff511ea0" target="_blank">here</a>] for more details</div>
